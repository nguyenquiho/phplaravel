...
<div class="section-conten-in-admin">
	<div class="row-title">Sửa bài viết</div>
	<div class="section-add">
		<form action="{{route('suabaiviet',$news->id)}}" method="post" enctype="multipart/form-data">
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="img-uploaded"><img src="source/image/news/{{$news->image}}" width="50" height="50"><span>{{$news->image}}</span></div>
				</div>
			</div>
			<div class="control-group" style="width: 80%">
					<span class="required">Nội dung</span>
					<textarea name="content" id="content" rows="10" cols="150">{{$news->content}}</textarea>
			</div>
