...
<div class="section-conten-in-admin">
	<div class="row-title">Thông báo</div>
	<div class="inp-search-in-admin">
		<button type="Text" class="add-product-btn"><a href="{{route('themthongbao')}}"><span class="glyphicon">&#x2b;</span>&nbsp;&nbsp;Thêm thông báo</a></button>
	<input type="text" class="inp-search-pro" placeholder="Tìm kiếm"><button class="btn-s"> Tìm </button>
	</div>
	...
	<table class="in-admin" id="title-tr-news">
		...
		<tr class="<?php if($i%2 ==0) echo"even-number"; else echo"odd-number"; ?>">
			...
			<td><?php echo $i++; ?></td>
			<td style="color: #3071a9;text-align: left;"><a href="">{{$no->title}}</a></td>
			...
			<td style="color: #3071a9">{{$no->id}}</td>	
		</tr>
		@endforeach
	</table>
	</div>
