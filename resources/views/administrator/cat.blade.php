...
<div class="section-conten-in-admin">
	<div class="row-title">Danh mục</div>
	<div class="inp-search-in-admin">
		<button type="Text" class="add-product-btn"><a href="{{route('themdanhmuc')}}"><span class="glyphicon">&#x2b;</span>&nbsp;&nbsp;Thêm danh mục</a></button>
	...
	<table class="in-admin" id="title-tr-news">
		...
		<tr class="<?php if($i%2 ==0) echo"even-number"; else echo"odd-number"; ?>">
			...
			<td><?php echo $i++; ?></td>
			<td style="color: #3071a9;text-align: center;"><a href="">{{$ty->name}}</a></td>
			...
			<td style="color: #3071a9">{{$ty->id}}</td>	
		</tr>
		@endforeach
	</table>
	</div>
