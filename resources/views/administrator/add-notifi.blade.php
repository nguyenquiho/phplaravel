...
<head>
	<meta charset="UTF-8">
	<title>Thông báo [Thêm thông báo]</title>
</head>
	<base href="{{asset('')}}">
...
<div class="section-conten-in-admin">
	<div class="row-title">Thêm thông báo</div>
	<div class="section-add">
		<form action="{{route('themthongbao')}}" method="post" enctype="multipart/form-data">
			...
			<div class="submit-group-nav-add-product">
				...
				<a href="{{route('thongbao')}}"><input type="button" name="" value="Thoát" ></a>
			</div>
